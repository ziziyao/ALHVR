...
def Inference(FLAGS):
    with open(FLAGS.root_path + '/data_list/MCNet/test.list', 'r') as f:
        image_list = f.readlines()
    image_list = sorted([item.replace('\n', '').split(".")[0] for item in image_list])
    snapshot_path = "/opt/data/private/yzy/train_alhvr/code/model/ACDC_{}_{}_labeled/".format( FLAGS.exp, FLAGS.labelnum)
    test_save_path = "/opt/data/private/yzy/train_alhvr/code/model/ACDC_{}_{}_labeled/{}_prediction/".format(FLAGS.exp, FLAGS.labelnum, FLAGS.model)
    ...
    save_model_path = os.path.join(snapshot_path, 'unet_fea_aux_best_model.pth')
